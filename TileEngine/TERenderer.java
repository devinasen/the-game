...
public class TERenderer {
     ...
     * if you select x = 60, y = 30, xOff = 3, yOff = 4 and then call renderFrame with a
    ...
    /**
     * Initializes StdDraw parameters and launches the StdDraw window. x and y are the
     * width and height of the world in number of tiles. If the TETile[][] array that you
     * pass to renderFrame is smaller than this, then extra blank space will be left
     * on the right and top edges of the frame. For example, if you select x = 60 and
     * y = 30, this method will create a 60 tile wide by 30 tile tall window. If
