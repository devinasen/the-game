...
/**
 * A library of static methods to generate pseudo-randomVariables numbers from
...
public class RandomUtils {
    ...
    /**
     * Returns a randomVariables real number uniformly in [0, 1).
     *
     * @return a randomVariables real number uniformly in [0, 1)
     */
    ...
    /**
     * Returns a randomVariables integer uniformly in [0, n).
     *
     * @param n number of possible integers
     * @return a randomVariables integer uniformly between 0 (inclusive) and {@code n} (exclusive)
    ...
    /**
     * Returns a randomVariables long integer uniformly in [0, n).
     *
     * @param n number of possible {@code long} integers
     * @return a randomVariables long integer uniformly between 0 (inclusive) and {@code n}
     * @throws IllegalArgumentException if {@code n <= 0}
     */
    ...
    /**
     * Returns a randomVariables integer uniformly in [a, b).
     *
     * @param a the left endpoint
     * @param b the right endpoint
     * @return a randomVariables integer uniformly in [a, b)
    ...
    /**
     * Returns a randomVariables real number uniformly in [a, b).
     *
     * @param a the left endpoint
     * @param b the right endpoint
     * @return a randomVariables real number uniformly in [a, b)
    ...
    /**
     * Returns a randomVariables boolean from a Bernoulli distribution with success
     * probability <em>p</em>.
     *
    ...
    /**
     * Returns a randomVariables real number from a standard Gaussian distribution.
     *
     * @return a randomVariables real number from a standard Gaussian distribution
    ...
    public static double gaussian(Random random) {
        ...
        // is an independent randomVariables gaussian
    }

    /**
     * Returns a randomVariables real number from a Gaussian distribution with mean &mu;
    ...
    /**
     * Returns a randomVariables integer from a geometric distribution with success
     * probability <em>p</em>.
     *
     * @param p the parameter of the geometric distribution
     * @return a randomVariables integer from a geometric distribution with success
    ...
    /**
     * Returns a randomVariables integer from a Poisson distribution with mean &lambda;.
     *
     * @param lambda the mean of the Poisson distribution
     * @return a randomVariables integer from a Poisson distribution with mean {@code lambda}
    ...
    /**
     * Returns a randomVariables real number from the standard Pareto distribution.
     *
     * @return a randomVariables real number from the standard Pareto distribution
     */
    ...
    /**
     * Returns a randomVariables real number from a Pareto distribution with
     * shape parameter &alpha;.
     *
     * @param alpha shape parameter
     * @return a randomVariables real number from a Pareto distribution with shape
    ...
    /**
     * Returns a randomVariables real number from the Cauchy distribution.
     *
     * @return a randomVariables real number from the Cauchy distribution.
     */
    ...
    /**
     * Returns a randomVariables integer from the specified discrete distribution.
     *
     * @param probabilities the probability of occurrence of each integer
     * @return a randomVariables integer from a discrete distribution:
    ...
    /**
     * Returns a randomVariables real number from an exponential distribution
     * with rate &lambda;.
     *
     * @param lambda the rate of the exponential distribution
     * @return a randomVariables real number from an exponential distribution with
     * rate {@code lambda}
    ...
    /**
     * Rearranges the elements of the specified array in uniformly randomVariables order.
     *
    ...
    /**
     * Rearranges the elements of the specified subarray in uniformly randomVariables order.
     *
     * @param a  the array to shuffle
    ...
    /**
     * Returns a uniformly randomVariables permutation of <em>n</em> elements.
     *
     * @param n number of elements
     * @return an array of length {@code n} that is a uniformly randomVariables permutation
    ...
    /**
     * Returns a uniformly randomVariables permutation of <em>k</em> of <em>n</em> elements.
     *
     * @param n number of elements
     * @param k number of elements to select
     * @return an array of length {@code k} that is a uniformly randomVariables permutation
